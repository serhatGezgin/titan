 ...
 *   <li>{@link org.yazgel.titan.xtext.titan.impl.FeatureImpl#isMany <em>Many</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FeatureImpl extends MinimalEObjectImpl.Container implements Feature
{
  ...
  public void setMany(boolean newMany)
  {
    ...
    many = newMany;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TitanPackage.FEATURE__MANY, oldMany, many));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TitanPackage.FEATURE__NAME:
        return getName();
      case TitanPackage.FEATURE__MANY:
        return isMany();
    }
